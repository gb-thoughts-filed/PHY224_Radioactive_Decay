...
def poisson_distribution(num_of_counts, average):
    return np.exp(-average) * (average ** num_of_counts) / special.gamma(num_of_counts + 1)
...
if __name__ == "__main__":
    ...
    count_rate = (num_of_counts_plate - np.average(num_of_counts_background))  # delta t given by data description
    ...
    histogram_plot(count_rate, range_1, 5)
